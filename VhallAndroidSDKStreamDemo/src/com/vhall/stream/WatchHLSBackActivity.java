 ...
 *
 */
public class WatchHLSBackActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_watch_back);
	...
	/*public void setSurfaceFixSize() {
		...
		surface.setLayoutParams(new RelativeLayout.LayoutParams(fixWidth,
		 fixHeight));
		if (surface != null)
